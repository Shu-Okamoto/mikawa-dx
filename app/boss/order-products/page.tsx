...
function OrderProductsContent() {
  ...
  const byCategory = new Map<string, OrderProduct[]>()
  ...
  return (
    <div style={{ fontFamily:'-apple-system,sans-serif', background:'#F5F1EA',
      ...
      <BossHeader title="🍱 店内商品マスタ" subtitle={user?.name} onLogout={logout} />
