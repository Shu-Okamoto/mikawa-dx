...
| `/boss/users` | `all` | ユーザー承認・role 付与・freee連携ID / freeeログイン番号 / 勤怠打刻の所属店舗設定・承認時 LINE 通知 |
...
- `User` — LINE 連携ユーザー（`role`, `lineUserId`, `displayName`, `pictureUrl`, `freeeId`, `freeeLoginNo`）
